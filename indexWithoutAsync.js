		...
		if (!error) {
			...
			$(links).each(function(i, link) {
				if (isUrl($(link).attr('href'))) {
					...
					if (($(link).attr('href').indexOf("medium.com/m/") > -1) || ($(link).attr('href').indexOf("medium.com/me/") > -1) || ($(link).attr('href').indexOf("medium.com/@") > -1) || ($(link).attr('href').indexOf("/edit") > -1)) {} else if ($(link).attr('href').indexOf("medium.com") > -1) {
